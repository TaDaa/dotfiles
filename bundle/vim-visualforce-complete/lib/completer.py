import sortlist, emmetparser,utils,json
...
def factory():
    ...
    class Completer():
                ...
                if not target:
                    ...
                    for symbol in target:
                        if symbol in symbols:
                            func(symbol,symbols[symbol])
        #def getCompletions(self,line,column,filter='all'):
            #state = self.emmet_parser.parse(line,column)
            #symbols = self.symbols
        ...
        def getCompletions(self,line,column,project,type,name,buffer):
                ...
                for fn in self.events['complete']:
                    fn(self,line,column,project,type,name,buffer)
